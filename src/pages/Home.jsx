...
const Home = () => {
  return (
    <HomeSection>
      <HomeHeader>
        <Catchword>Explore the World Through Your Screens</Catchword>
        <MainDesc>
      ...
      <WebsiteDesc>
        ...
        <FlexContainer>
          ...
          <Thumbnails
            src="https://img.freepik.com/free-vector/remote-control-streaming-media-home-networking-access-idea-integrated-entertainment-technology-internet-television-show-broadcasting-vector-isolated-concept-metaphor-illustration_335657-2216.jpg?w=740&t=st=1668516000~exp=1668516600~hmac=6341bbd3216f53ee807205164e37628d066dc836866d5b4246f64a1bbe9677e1"
            alt="TvShowThumbnail"
          />
        </FlexContainer>
        <FlexContainer>
          <Thumbnails
            src="https://img.freepik.com/free-vector/neon-style-coming-soon-glowing-background-design_1017-25516.jpg?w=1380&t=st=1668516025~exp=1668516625~hmac=079c41474b45e3aba9bb49518f6cdc07c79ddd8d8527ab3a2c850857d6193659"
            alt="ComingSoon"
          />
          <Descriptions>
